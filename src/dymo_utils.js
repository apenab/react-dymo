 ...
 *
 * @param {string} printer - Dymo Printer
 * @param {string} xml - XML parsed to string
 * @returns AxiosResponse
 */
export function printSingleLabel(printer, xml) {
  return dymoRequestBuilder({
    method: "POST",
    wsAction: "printLabel",
    axiosOtherParams: {
      data: `printerName=${encodeURIComponent(printer)}&printParamsXml=&labelXml=${encodeURIComponent(
        xml
      )}&labelSetXml=`,
    },
  });
